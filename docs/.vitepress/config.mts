    ...
    sidebar: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "PX4 Offboard Policy Receipts", link: "/guides/px4-offboard-policy-receipts" },
          { text: "LeRobot Policy Actuation Receipts", link: "/guides/lerobot-policy-actuation-receipts" },
          { text: "Solar Field Operations Policy Receipts", link: "/guides/solar-field-operations-policy-receipts" },
          { text: "Sunnybotics T800 ROS2 Integration", link: "/guides/sunnybotics-t800-ros2-integration" },
      ...
      },
      {
        ...
        items: [
          ...
          { text: "Solar Field Robot Policy Template", link: "/profiles/solar-field-robot.policy.template" },
