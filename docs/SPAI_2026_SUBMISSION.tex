...
% --- IJCAI 2026 style (download from https://ijcai.org/authors_kit) ---
% \usepackage{ijcai26}  % Uncomment when ijcai26.sty is available
% Fallback geometry for review / arXiv preprint:
...
\author{
  Anonymous Author(s)\\
  \small \textit{Open Source — \url{https://github.com/sint-ai/sint-protocol}}
}
