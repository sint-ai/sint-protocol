...
| --- | --- | --- | --- | --- | --- |
| OpenSSF Best Practices project profile started | done | [Issue #191](https://github.com/sint-ai/sint-protocol/issues/191), [OpenSSF Best Practices Project Profile](./openssf-best-practices-profile.md), [AAIF Evidence Item](./aaif-evidence/2026-08-01-openssf-profile-start.md) | core maintainers | 2026-06-01 | Public project profile is now published and linked to the existing release, conformance, security, and dependency-review evidence |
...
| SBOM or dependency review path documented | done | [Issue #194](https://github.com/sint-ai/sint-protocol/issues/194), [Dependency Review And SBOM Path](../guides/dependency-review-and-sbom), [Dependency Review Report](../reports/dependency-review-latest), [Remediation Issue #209](https://github.com/sint-ai/sint-protocol/issues/209) | core maintainers | 2026-06-15 | Workflow, command path, published artifact, and high-severity remediation tracker are now public |
