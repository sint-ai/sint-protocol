...
export function computeSigningPayload(
  ...
  return canonicalJSONStringify({
    ...
    deploymentEnvelope: token.deploymentEnvelope,
    manufacturingEnvelope: token.manufacturingEnvelope,
...
export function issueCapabilityToken(
  ...
  const unsignedToken: Omit<SintCapabilityToken, "signature"> = {
    ...
    deploymentEnvelope: request.deploymentEnvelope,
    manufacturingEnvelope: request.manufacturingEnvelope,
