...
import type { Result, SintCapsuleManifest } from "@sint-ai/core";
import { ok, err } from "@sint-ai/core";
import { capsuleManifestSchema } from "@sint-ai/core";
 ...
 * @example
 * ```ts
 * import { validateManifest } from "@sint-ai/engine-capsule-sandbox";
 *
